...
mods_summary <-
  tribble(
    ...
    "mod_13_poplvl", "mod_13",  "real", "binned", "data_obs_count_poplvl", "size_class", 774, "norm & lnorm", "Yes", "per species", "predicted from par1",
  )
...
mod_13_poplvl_data <-
  make_datalist(data_obs_count_poplvl, data_obs_count_poplvl)
...
mod_13_fit <- run_stanmod("mod_13_allspp")
mod_13_pars <- extract_pars("mod_13_allspp", overwrite_pars = FALSE)
...
mod_13_pars_extra <-
  mod_13_pars %>% 
  left_join(species_indx_table_new) %>% 
