...
traceplot(mod_10_fit, pars = "mu")
traceplot(mod_10_fit, pars = "sigma")
...
if(!file.exists("output/model_fits/model_12.rds") | rerun_models){
  mod_12 <-
    stan(
  ...
  saveRDS(mod_12, "output/model_fits/model_12.rds")
}

mod_12 <- readRDS("output/model_fits/model_12.rds")
