...
| model_09   |          | real | 20/774 | bin       | norm         | No              | Yes             | per species     | per species         |
| model_10   |          | real | 20/774 | bin       | lnorm        | No              | Yes             | per species     | per species         |
| model_11   |          | real | 20/774 | bin       | norm         | No              | Yes             | per species     | predicted from par1 |
| model_12   |          | real | 20/774 | bin       | lnorm        | No              | Yes             | per species     | predicted from par1 |
| model_13   |          | real | 20/774 | bin       | norm & lnorm | No              | Yes             | per species     | per species         |
| model_14   |          | real | 20/774 | bin       | norm & lnorm | No              | Yes             | per species     | predicted from par1 |
...
save_traceplot <- function(model, pars, overwrite = FALSE){
  
  filename <- paste0("output/traceplots/", substitute(model), "_", pars, ".png")
...
if(!file.exists("output/model_fits/model_05_06_plot.png") | rerun_figures){
...
save_plot(plot = mod_05vsmod_06_plot, 
            filename = "output/model_fits/model_05_06_plot.png", 
            base_height = 10)
...
mod_07_pars <- extract_pars(stan_model = mod_07)
...
save_traceplot(mod_07, "mu")
save_traceplot(mod_07, "sigma")
save_traceplot(mod_07, "beta_0")
save_traceplot(mod_07, "beta_1")
...
```{r}
save_traceplot(mod_08, "meanlog")
save_traceplot(mod_08, "sdlog")
save_traceplot(mod_08, "beta_0")
save_traceplot(mod_08, "beta_1")
```
...
```{r}
save_traceplot(mod_09, "mu")
save_traceplot(mod_09, "sigma")
```
...
save_traceplot(mod_10, "meanlog")
save_traceplot(mod_10, "sdlog")
...
save_traceplot(mod_11, "mu")
save_traceplot(mod_11, "sigma")
save_traceplot(mod_11, "beta_0")
save_traceplot(mod_11, "beta_1")
...
traceplot(mod_12, pars = "meanlog")
traceplot(mod_08, pars = "meanlog")
traceplot(mod_08, pars = "beta_1")

save_traceplot(mod_12, "sdlog")
save_traceplot(mod_12, "beta_0")
save_traceplot(mod_12, "beta_1")
