...
run_stanmod <- function(mod_name, overwrite = FALSE, iter = 2000, warmup = 1500, chains = 3){
...
if(run_largemodels){
  ...
  mod_05_allspp_fit  <- run_stanmod("mod_05_allspp")
  mod_05_allspp_pars <- extract_pars(mod_05_allspp_fit)
  plot_mod_fit("mod_05_allspp", overwrite = TRUE)
}
...
if(run_largemodels){
  ...
  mod_10_allspp_fit  <- run_stanmod("mod_10_allspp", overwrite = T)
  mod_10_allspp_pars <- extract_pars(mod_10_allspp_fit)
  plot_mod_fit("mod_10_allspp")
...
```{r mod11-modelfit}
if(run_largemodels){
  mod_11_allspp_data <- make_datalist(data_obs_count_allspp, 
                                      data_obs_count_allspp_byspp)
  
  mod_11_allspp_fit  <- run_stanmod("mod_11_allspp", overwrite = T)
  mod_11_allspp_pars <- extract_pars(mod_11_allspp_fit)
  plot_mod_fit("mod_11_allspp")
...
mod_13_fit  <- run_stanmod("mod_13", chains = 3, overwrite = TRUE)
